...
@implementation YQHPicTxtTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [YQHPicTxtTextView maxCharactersPerLine];
...
{
    return [YQHPicTxtTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [YQHPicTxtTextView maxCharactersPerLine]) + 1;
}
